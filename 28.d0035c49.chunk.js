    ...
    [28], {
        ...
        dT9Q: function(e, t, n) {
            ...
            t.a = function MessagePreview() {
                ...
                Object(S.useEffect)(function setLatestMessageFromConvo() {
                    ...
                    z && (X || P && x && (null === P || void 0 === P ? void 0 : P.id) !== (null === x || void 0 === x ? void 0 : x.id)) && T(Object(C.d)(!1))
                }, [T, z, x, P, X]), Object(S.useLayoutEffect)(function() {
                    if (ee && n) {
                        var e = n ? n.width : 0,
                            t = n ? n.height : 0,
                            c = e + i.b + 40,
            ...
            var c = n("mj2O"),
                ...
                E = function OpenSocket(e) {
                    var t = e.session_token,
                        ...
                        c = e.socketCluster,
                        o = e.ip,
                        a = "is_mobile_".concat(Object(O.d)(!0)),
                        i = s.a.WS_PROTOCOL,
                    ...
                    return A.connect(), A.onError(function(e, t, a) {
                        ...
                        c === j.c.CHAT && (E && Object(g.o)({
                            ...
                            internal: !0
                        }), h.setAttempt("reconnect", 1), 1005 === t ? setTimeout(function() {
                            A.connect()
                        }, 2e3) : A.connect()))
                    }), A
                },
                                                    ...
                                                    case 0:
                                                        i = n.channel(t), c.forEach(function(e) {
                                                            ...
                                                            if (Object(d.l)() && h.shouldRefetchMessagesOnChannelJoin() && t.startsWith(j.b.USER)) {
                                                                ...
                                                                Object(g.o)({
                                                                    data: ["Joined user channel ".concat(t, " after disconnect and user interacted with active conversation"), "Is_mobile_".concat(Object(O.d)(!0)), "Close Code: ".concat(h.closeCode), "Has Refetch Gate: ".concat(n), "Is Join After Connection Lost: ".concat(h.isJoinAfterConnectionLost)],
                                                                    internal: !0
                                                                });
        ...
        yXOZ: function(e, t, n) {
            ...
            t.a = function WidgetIcon() {
                ...
                }, [Re, Ne, z, ee]), Object(T.useEffect)(function() {
                    le && Object(A.a)({
                ...
                }, [Re, le]), Object(T.useEffect)(function() {
                    Q && !_e && G(!1)
                }, [Q, _e, G]), Object(T.useEffect)(function() {
                    ee || Object(A.a)({
                ...
                }, [Y, q, te, ue, ee]), Object(T.useEffect)(function() {
                    de && de.length > 0 && !ee && Object(W.a)()
                }, [ee, de]), Object(T.useEffect)(function() {
                    Object(A.c)({
                ...
                var Je = function onToggleChat() {
                    ...
                    Pe = Object(T.useMemo)(function() {
                        return !we || ye || Y ? null : Ce
                    }, [Ce, ye, Y, we]),
                    Ue = Object(T.useMemo)(function() {
                ...
                return $ ? M.a.createElement(M.a.Fragment, null, M.a.createElement("style", null, "\n          :root {\n            --bgColor:".concat(me.background, ";\n            --bgColorHover:").concat(me.backgroundOnHover, ";\n          }\n        ")), M.a.createElement("div", {
                    className: i()("drift-widget-controller drift-widget-controller--align-".concat(ne), [Me], {
                        "drift-widget-controller--closed": !Object(U.d)() && Y,
                    ...
                    className: i()("drift-widget-controller-icon", [Me], {
                        "drift-widget-controller-icon--default": we && !ye && !Y
                    }),
                    style: Pe
                }, M.a.createElement("div", {
                    className: "drift-controller-icon--active"
                }, Te === H && M.a.createElement(r.p, {
                    fill: pe
                }), Te === F && M.a.createElement(s.a, {
                    className: i()([Me], "drift-controller-icon--avatar"),
                    avatarClassName: i()([Me], "drift-controller-icon--avatar-avatar"),
                    id: Ae
                }), Te === Z && !we && Ee), M.a.createElement("div", {
                    className: "drift-controller-icon--close",
                    style: {
                        backgroundColor: pe
                    }
                })), le && Re > 0 && M.a.createElement("div", {
