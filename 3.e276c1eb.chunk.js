    ...
    [3], {
            ...
            function useGetConversationRatingMessage(e) {
                return Object(c.useMemo)(function() {
                    if (e && e.length) {
                        var t = Object(a.a)(e);
                        if (!Object(i.m)(t)) {
                            if (Object(r.l)(t)) return t;
                            if (Object(r.k)(t) && e.length > 1) {
                                var n = e[e.length - 2];
                                if (Object(r.l)(n)) return n
                            }
                        }
                    }
                    return null
                    ...
                    if (t) {
                        if (e !== u) {
                            ...
                            if (0 === e.length && n > 0) o([]);
                                ...
                                if (s.current !== t || n === e.length) return s.current = t, void o(e);
                                var r = function pushMessage() {
                                        return o(e.slice(0, n + 1))
                                    },
                                    c = e[n] || e[0];
                                if (!(Date.now() - c.createdAt > 5e3 || Object(a.i)(c) || Object(a.j)(c))) return l.current = window.setTimeout(function() {
                                        l.current = null, r()
                                    }, 800),
                                    function() {
        ...
        "6fy/": function(e, t, n) {
            ...
            var r = n("kXeL"),
                ...
                u = n("Tr4L"),
                o = n("uDfI");
            t.a = function useUserResolution() {
                var e = Object(u.a)().t,
                ...
                return Object(i.useMemo)(function() {
                    return {
                        id: t.id,
                        name: Object(c.a)(e("user.self"), ["name"], t),
                        avatar: Object(c.a)(a.a, ["socialProfile", "avatar"], t),
                        email: Object(c.a)(null, ["socialProfile", "email"], t)
                    }
                }, [t, e])
            }
        },
                ...
                var t = e.inputRef,
                    ...
                    v = Object(i.useCallback)(function(e) {
                        if (e.clipboardData && e.clipboardData.files) {
                            ...
                            t.length && s(Object(c.a)([].concat(Object(r.a)(o), Object(r.a)(t)))), t.length && b(e.clipboardData.getData("Text"))
                        }
                    }, [o]);
                return Object(i.useEffect)(function() {
                    t && (t.current.onpaste = v)
                }, [t, v]), {
                    pastedTextFromFiles: d,
                    pastedFiles: o,
        ...
        "7IKl": function(e, t, n) {
            ...
            t.a = function useAgentName(e) {
                ...
                return Object(r.useMemo)(function() {
                    ...
                    return t && t.name && !Object(i.a)(t.name) ? t.name : u("agent")
                }, [n, e, u])
            }
        },
        "8/1l": function(e, t, n) {
            ...
            var r = n("mj2O"),
                ...
                o = n("ERkP"),
                s = n("uDfI");
            t.a = function useSendMessage() {
                var e = Object(s.b)(),
                    t = Object(s.c)(u.a);
                return Object(o.useCallback)(function() {
                    var n = Object(c.a)(a.a.mark(function _callee(n) {
                        return a.a.wrap(function _callee$(r) {
                            for (;;) switch (r.prev = r.next) {
                                case 0:
                                    n.previousActiveConversationId = t, e(Object(i.p)(n));
                                case 2:
                                case "end":
                                    return r.stop()
                            }
        ...
        BcLd: function(e, t, n) {
            "use strict";
            n.d(t, "a", function() {
                return processGifsForAnimationControl
            });
            var r = n("8ZCy"),
                a = 60;
            ...
            function process(e) {
                var t = null,
                    n = null,
                    c = !1,
                    i = e.getAttribute("data-giffer-alt"),
                    u = document.createElement("canvas"),
                    o = e.getAttribute("data-giffer-duration"),
                    s = e.getAttribute("data-giffer");
                e.style.display = "block", e.onload = function() {
                    if (u.getContext && u.getContext("2d")) {
                        var l = e.width,
                            f = e.height,
                            d = function createContainer(e, t) {
                                var n = document.createElement("button"),
                                    r = e.getAttribute("class"),
                                    c = e.getAttribute("id"),
                                    i = ["width:" + a + "px", "height:" + a + "px", "border-radius:" + a / 2 + "px", "background:rgba(0, 0, 0, 0.3)", "position:absolute", "top:50%", "left:50%", "margin:-" + a / 2 + "px"].join(";"),
                                    u = ["width: 0", "height: 0", "border-top: 14px solid transparent", "border-bottom: 14px solid transparent", "border-left: 14px solid rgba(0, 0, 0, 0.5)", "position: absolute", "left: 26px", "top: 16px"].join(";");
                                r && n.setAttribute("class", e.getAttribute("class")), c && n.setAttribute("id", e.getAttribute("id")), n.setAttribute("style", "position: relative; cursor: pointer; background: none; border: none; padding: 0;"), n.setAttribute("aria-label", "Play or pause GIF animation for ".concat(t));
                                var o = document.createElement("div");
                                o.setAttribute("class", "giffer-play-button"), o.setAttribute("style", i);
                                var s = document.createElement("div");
                                return s.setAttribute("style", u), o.appendChild(s), n.appendChild(o), e.parentNode.replaceChild(n, e), {
                                    c: n,
                                    p: o
                                }
                            }(e, i),
                            b = d.c,
                            v = d.p,
                            p = function calculatePercentageDim(e, t, n, r, a) {
                                var c = e.parentNode.offsetWidth,
                                    i = r / a;
                                return t.toString().indexOf("%") > 0 ? n = (t = (t = parseInt(t.toString().replace("%", ""))) / 100 * c) / i : n.toString().indexOf("%") > 0 && (t = (n = (n = parseInt(n.toString().replace("%", ""))) / 100 * c) * i), {
                                    w: t,
                                    h: n
                                }
                            }(b, l, f, e.width, e.height);
                        b.addEventListener("click", function() {
                            clearTimeout(t), c ? (c = !1, b.appendChild(v), b.removeChild(n), b.appendChild(u), n = null) : (c = !0, (n = document.createElement("img")).setAttribute("style", "width:100%;height:100%;"), n.setAttribute("data-uri", "".concat(Math.floor(1e5 * Math.random()) + 1)), setTimeout(function() {
                                n.src = s
                            }, 0), b.removeChild(v), b.removeChild(u), b.appendChild(n), parseInt(o) > 0 && (t = setTimeout(function() {
                                c = !1, b.appendChild(v), b.removeChild(n), b.appendChild(u), n = null
                            }, o)))
        ...
        "P+wr": function(e, t, n) {
            ...
            var r = n("mj2O"),
                ...
                f = n("uDfI"),
                d = n("vwUF");
            t.a = function useAttachmentUpload(e) {
                var t = e.onAttachmentUploadComplete,
                    n = e.activeConversation,
                    r = Object(f.b)(),
                    b = Object(l.useState)(d.b.NONE),
                    v = Object(i.a)(b, 2),
                    p = v[0],
                    O = v[1],
                    g = Object(f.c)(function(e) {
                        return Object(s.a)(!1, ["embed", "configuration", "theme"], e)
                            ...
                            return a.a.wrap(function _callee$(a) {
                                for (;;) switch (a.prev = a.next) {
                                    ...
                                    case 2:
                                        ...
                                        return a.abrupt("return");
                                    case 4:
                                        return O(d.b.PENDING), c = e.filter(function(e) {
                                            return e.size < d.a.DEFAULT
                                        }).map(function(e) {
                                            return Object(u.b)(e, n)
                                        }), a.prev = 6, a.next = 9, Promise.all(c);
                                    case 9:
                                        i = a.sent, s = i.map(function(e) {
                                            return e.data
                                        }), l = s.map(function(e) {
                                            return e.id
                                        }), r(Object(o.f)({
                                            attachments: s
                                        })), t(l), O(d.b.NONE), a.next = 20;
                                        break;
                                    case 17:
                                        a.prev = 17, a.t0 = a.catch(6), O(d.b.ERROR);
                                    case 20:
                                    case "end":
                                        return a.stop()
                                }
        ...
        Re5R: function(e, t, n) {
            ...
            var c = r.forwardRef(SvgGearWheel);
            n.p
        },
        Sn8X: function(e, t, n) {
            "use strict";
            ...
            t.a = function useLanguageSwitcher() {
                ...
                Object(a.useEffect)(function() {
                    e && Object(i.l)(e.changeLanguage) && e.changeLanguage(Object(u.c)(t))
                }, [e, t])
            }
        },
        ey6Y: function(e, t, n) {
        ...
        gRD2: function(e, t, n) {
            ...
            t.a = function useFetchActiveConverationMessages() {
                var e = Object(d.b)(),
                    ...
                    n = Object(d.c)(o.f);
                return {
                    fetchMessages: Object(f.useCallback)(function() {
                        var r = Object(c.a)(a.a.mark(function _callee(r) {
                            var c, o, f, d, v, p;
                            return a.a.wrap(function _callee$(a) {
                                for (;;) switch (a.prev = a.next) {
                                    case 0:
                                        if (c = r.limit, o = void 0 === c ? 30 : c, f = r.from, d = void 0 === f ? null : f, !n) {
                                            a.next = 3;
                                            break
                                        }
                                        return a.abrupt("return");
                                    case 3:
                                        return a.prev = 3, a.next = 6, Object(i.d)({
                                            conversationId: t,
                                            limit: o,
                                            from: d
                                        });
                                    case 6:
                                        return v = a.sent, p = v.data, e(Object(u.l)({
                                            messages: p.data,
                                            hasMoreMessages: Object(l.a)(!1, ["pagination", "more"], p),
                                            nextPageMessageId: Object(l.a)(null, ["pagination", "next"], p),
                                            conversationId: t
                                        })), a.abrupt("return", p);
                                    case 12:
                                        a.prev = 12, a.t0 = a.catch(3), Object(b.f)([s.a.MESSAGE.FETCH_MESSAGES, " convoId:" + t], a.t0, !0);
                                    case 15:
                                    case "end":
                                        return a.stop()
                                }
        ...
        hhdZ: function(e, t, n) {
            ...
            t.a = function useLastMessage(e) {
                var t = Object(u.c)(function(t) {
                        return Object(a.a)(null, ["conversations", "conversations", e, "lastMessage"], t)
                    }),
                    n = Object(u.c)(function(t) {
                        var n = Object(a.a)({}, ["conversations", "messages", e], t);
                        if (!Object(c.a)(n)) {
                            var u = Object(r.s)(n);
                            if (u.length) return Object(i.a)(u)
                        }
                        return null
                    });
                return t || n || {}
        ...
        hiXw: function(e, t, n) {
            ...
            function needsNewLine() {
                ...
                return !!u.a.find(function(e) {
                    return t.indexOf(e) > -1 || n.indexOf(e) > -1
                })
            }

            function useEnterToSubmit() {
                ...
                return Object(s.useEffect)(function() {
                    function _initialStateFromStorage() {
                        return (_initialStateFromStorage = Object(c.a)(a.a.mark(function _callee() {
                            var e, t;
                            return a.a.wrap(function _callee$(n) {
                                for (;;) switch (n.prev = n.next) {
                                    case 0:
                                        return n.prev = 0, n.next = 3, b.a.get(l.c);
                                    case 3:
                                        e = n.sent, t = e.data, r(Object(d.m)(t) ? !needsNewLine() : t), n.next = 11;
                                        break;
                                    case 8:
                    ...
                    u || function initialStateFromStorage() {
                        return _initialStateFromStorage.apply(this, arguments)
                    }()
                }, [u]), [n, function() {
                    r(function(e) {
                        return b.a.set(l.c, !e), !e
                    })
                }]
            }
        },
        jITz: function(e, t, n) {
            ...
            t.a = function useKeyPress(e) {
                ...
                return c("keydown", p, n), c("keyup", O, n), b
            }
        },
        krLb: function(e, t, n) {
            "use strict";
            ...
            var s = n("SFoa"),
                ...
                f = n("0lfv");
            n.d(t, "b", function() {
                return useFetchTrendingGifs
            }), n.d(t, "a", function() {
                return useFetchGifsByKeyword
            });
            var d = 51,
                b = [],
                v = {};
            ...
            function filterBrokenGifLinks(e) {
                return e.filter(function filterBrokenGif(e) {
                    var t = Object(l.a)(null, ["images", "preview_gif", "url"], e),
                        n = Object(l.a)(null, ["images", "original_still", "url"], e);
                    return !(!t || !n)
                })
            }

            function useFetchTrendingGifs(e) {
                ...
                return Object(o.useEffect)(function() {
                    function _fetchTrending() {
                        return (_fetchTrending = Object(c.a)(a.a.mark(function _callee() {
                            var e, t, n;
                            return a.a.wrap(function _callee$(r) {
                                for (;;) switch (r.prev = r.next) {
                                    case 0:
                                        return r.prev = 0, s(!0), r.next = 4, Object(u.b)(d);
                                    case 4:
                                        t = r.sent, n = t.data, b = filterBrokenGifLinks(null !== (e = null === n || void 0 === n ? void 0 : n.data) && void 0 !== e ? e : []), r.next = 12;
                                        break;
                                    case 9:
                                        r.prev = 9, r.t0 = r.catch(0), Object(f.y)(["Could not search trending gifs", r.t0]);
                                    case 12:
                                        return r.prev = 12, s(!1), r.finish(12);
                                    case 15:
                                    case "end":
                                        return r.stop()
                                }
                    ...
                    e && Object(f.m)(b) && function fetchTrending() {
            ...
            function useFetchGifsByKeyword(e, t) {
                ...
                return Object(o.useEffect)(function() {
                    function _searchGifs() {
                        return (_searchGifs = Object(c.a)(a.a.mark(function _callee2() {
                            var e, t;
                            return a.a.wrap(function _callee2$(n) {
                                for (;;) switch (n.prev = n.next) {
                                    case 0:
                                        return n.prev = 0, g(!0), n.next = 4, Object(u.a)(l, d, {
                                            locale: r
                                        });
                                    case 4:
                                        e = n.sent, t = e.data, v[l] = filterBrokenGifLinks(t.data), n.next = 12;
                                        break;
                                    case 9:
                                        n.prev = 9, n.t0 = n.catch(0), Object(f.y)(["Could not search gifs by keyword", n.t0]);
                                    case 12:
                                        return n.prev = 12, g(!1), n.finish(12);
                                    case 15:
                                    case "end":
                                        return n.stop()
                                }
                    ...
                    t && l && !v[l] && function searchGifs() {
                        return _searchGifs.apply(this, arguments)
                    }()
                }, [r, l, t]), {
                    debouncedValue: l,
                    isSearchLoading: O,
                    searchedGiphys: null !== (n = null === v || void 0 === v ? void 0 : v[l]) && void 0 !== n ? n : []
                }
            }
        },
        nvPd: function(e, t, n) {
            ...
            t.a = function useInputValue(e) {
                ...
                return {
                    value: c,
                    onChange: Object(a.useCallback)(function(e) {
                        var t, n;
                        i(null !== (t = null === e || void 0 === e ? void 0 : null === (n = e.currentTarget) || void 0 === n ? void 0 : n.value) && void 0 !== t ? t : "")
                    }, [])
                }
            }
        },
        uQkC: function(e, t, n) {
            ...
            var r = n("qwiD"),
                ...
                c = n("uDfI"),
                i = n("7VeV");
            t.a = function useTypingIndicators(e) {
                var t = e.activeConversationId,
                    ...
                    l = Object(a.useCallback)(function(e) {
                        n(Object(r.e)("chat", "user", "typing:".concat(e), {
                            userId: s,
                            userType: o,
                            conversationId: t,
                            participants: []
                    ...
                    f = Object(a.useMemo)(function() {
                        return Object(i.throttle)(5e3, !1, function() {
                            return l("started")
                        })
                    }, [l]);
                return {
                    sendTypingStarted: function sendTypingStarted() {
                        f(), u.current && window.clearTimeout(u.current), u.current = window.setTimeout(function() {
                            return l("finished")
                        }, 5e3)
                    },
                    sendTypingFinished: function sendTypingFinished() {
                        u.current && (window.clearTimeout(u.current), u.current = null), l("finished")
                    }
                }
            }
        },
        vLHT: function(e, t, n) {
            ...
            t.a = function useComposerState() {
                var e = Object(l.c)(a.g),
                    t = Object(l.c)(a.j);
                return Object(s.useMemo)(function() {
                    if (e) return r.a.UNAVAILABLE;
                    if (Object(i.a)(t)) return r.a.AVAILABLE;
                    var n = Object(u.a)(t),
                        a = Object(o.a)(-2, t),
                        s = Object(c.e)(a) && Object(c.i)(n);
                    return Object(c.e)(n) || s || Object(c.j)(n) ? r.a.UNAVAILABLE_BUTTONS : Object(c.o)(n) || Object(c.o)(a) && Object(c.i)(n) ? r.a.AVAILABLE_BUTTONS : r.a.AVAILABLE
                }, [e, t])
            }
        },
        vwUF: function(e, t, n) {
        ...
        "xqp/": function(e, t, n) {
            ...
            var r = n("ERkP"),
                a = n("7VeV");
            t.a = function useScroll(e, t) {
                var n = Object(r.useRef)(),
                    c = Object(r.useMemo)(function() {
                        return Object(a.throttle)(250, !1, function(e) {
                ...
                Object(r.useEffect)(function() {
                    ...
                    var e = t.current;
                    if (e) return e.addEventListener("scroll", c),
                        function() {
        ...
        z24s: function(e, t, n) {
            ...
            t.a = function useKeyboardNavigation(e) {
                var t = Object(a.useState)(!1),
                    ...
                    c = n[0],
                    i = n[1],
                    u = Object(a.useCallback)(function(t) {
                        "Tab" === t.key && t.target === e.current && i(!0)
                    }, [e]),
                    o = Object(a.useCallback)(function(t) {
                        t.target === e.current && i(!1)
                    }, [e]);
                return Object(a.useEffect)(function() {
                    return window.addEventListener("keyup", u), window.addEventListener("focusout", o),
                        function() {
                            window.removeEventListener("keyup", u), window.removeEventListener("focusout", o)
                        }
                }, [o, u]), c
            }
        }
