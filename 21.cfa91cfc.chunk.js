    ...
    [21], {
        ...
        "1Fob": function(e, t, n) {
            ...
            function decodeComponents(e, t) {
                ...
                var n = e.slice(0, t),
                    o = e.slice(t);
                return Array.prototype.concat.call([], decodeComponents(n), decodeComponents(o))
            }
            ...
            function decode(e) {
                try {
                    ...
                    for (var t = e.match(o), n = 1; n < t.length; n++) t = (e = decodeComponents(t, n).join("")).match(o);
                    return e
                }
            }
                            ...
                            if (m && p && ("string" !== typeof p && "boolean" !== typeof p && "number" !== typeof p) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(g) < 0 && ("string" !== typeof v || "[object Array]" !== g)) {
                                ...
                                if (O || k || E) {
                                    ...
                                    if ("fallback" === this.options.saveMissingTo && L && L[0])
                                        for (var T = 0; T < L.length; T++) C.push(L[T]);
                                    ...
                                    if (this.options.saveMissing) {
                                        ...
                                        this.options.saveMissingPlurals && _ ? C.forEach(function(e) {
